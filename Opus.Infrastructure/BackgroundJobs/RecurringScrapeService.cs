...
namespace Opus.Infrastructure.BackgroundJobs;
    ...
    private async Task ProcessWebsitesAsync(CancellationToken stoppingToken)
    {
        ...
        foreach (var website in websites)
        {
            ...
            foreach (var page in scrapedPages)
            {
                ...
                await scope.ServiceProvider.GetRequiredService<IEmbeddingRepository>().InsertEmbeddingAsync(new Opus.Domain.Entities.Embedding
                {
